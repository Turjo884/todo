          ...
          <div class="row">
              <div class="col-lg-12">
                ...
                <div class="card">
                  ...
                  <table class="table">
                      ...
                      <tbody>
                        ...
                        $sql ="SELECT * FROM todo WHERE user_id = '$user_id' ORDER BY id DESC";
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <div class="action-links">
                                      <ul>
                                        <li>
                                          <a href="self.php?do=Edit&id=<?php echo $id; ?>"><i class="fa fa-edit"></i></a>
                                        </li>
                                        <li>
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <div class="modal-conformation">
                                          <ul>
                                            <li>
                                              <a href="self.php?do=Delete&id=<?php echo $id; ?>" class="btn btn-danger">Confirm</a>
                                            </li>
                                            <li>
                                            <a href="self.php?do=Delete&id=<?php echo $id; ?>" class="btn btn-success">Cancel</a>
                                            </li>
                                          </ul>
                                        </div>
                                      </div>
                ...
                <div class="card">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                    <form action="self.php?do=Store" method="POST">
                      <div class="row">
                        <div class="col-lg-6">
                ...
                // Start Store Section
                  ...
                  if(isset($_POST['addTask'])){
                    ...
                    if($addTask){
                      header("Location: self.php?do=Manage");
                    }
                    else{
                  ...
                  if(isset($_GET['id'])){
                    ...
                    while($row = mysqli_fetch_assoc($readTask)){
                      ...
                      <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                          <form action="self.php?do=Update" method="POST">
                            <div class="row">
                              <div class="col-lg-6">
                                <div class="form-group">
                                  <label>Task Title</label>
