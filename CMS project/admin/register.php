...
<div class="register-box">
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <!-- Php Data Collect Operation Start -->
      ...
      if($password == $retype ){
        ...
        $sql = "INSERT INTO users (name, email, password, role, join_date) VALUES ('$name', '$email', '$hassedPass', 1, now())";
      ...
      <!-- Php Data Collect Operation End -->
